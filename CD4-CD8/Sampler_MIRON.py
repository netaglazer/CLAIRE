...
def read_data(datafile, file_key, human=True):
    ...
    if file_key == 'memory':
        ...
        for index in range(len(data)):
            ...
            sample['tcrb'] = data['cdr3_aa'][index]
            sample['va'] = 'UNK' #data['TRAV'][index]
            sample['ja'] = 'UNK' #data['TRAJ'][index]
            sample['vb'] = data['v_gene'][index]
            sample['jb'] = data['j_gene'][index]
            ...
            sample['mhc'] = 'UNK' #data['fixed_hla_list'][index]
...
def sample():
    ...
    sample_data('memory.pickle', 'memory', 'memory_train_samples', 'memory_test_samples', human=False)
    t2 = time.time()
