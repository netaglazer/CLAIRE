...
def sample():
    ...
    # sample_data('data/McPAS-TCR_fixed.csv', 'mcpas', 'mcpas_train_samples', 'mcpas_test_samples', human=False)
    sample_data('data/CD_p_filter10000.csv', 'cd_data', 'cd_p_filter_train_samples', 'cd_p_filter_test_samples', human=False)
    # sample_data('data/CD_data.csv', 'cd_data', 'cd_train_samples', 'cd_test_samples', human=False)
    t2 = time.time()
    print('done in ' + str(t2 - t1) + ' seconds')
...
def sample_all():
    t1 = time.time()
    print('sampling mcpas...')
    sample_all_data('data/CD_data_preg_50.csv', 'cd_data', 'p_train_samples', 'p_test_samples', human=False)
    t2 = time.time()
    print('done in ' + str(t2 - t1) + ' seconds')
    pass
